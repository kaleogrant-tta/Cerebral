...
t_charts, t_insights, t_brands, t_redeem, t_projections, t_gloss, t_promo = st.tabs(
    ["Charts", "Insights", "Brands", "Redemptions", "Projections", "What the terms mean", "Promo Lab"])
